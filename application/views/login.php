          ...
          <div class="card-body">
            <form data-parsley-validate method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col">
                  <div class="text-center">
                    <p><span class="text-bold"><a href="<?php echo base_url('home/lupa_password'); ?>">Lupa Password ?</a></span></p>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="text-center">
                    <p>Belum punya akun? Silahkan klik <span class="text-bold"><a href="<?php echo base_url('home/daftarakun'); ?>">Daftar</a> !</span></p>
                  </div>
                </div>
              </div>
            </form>
